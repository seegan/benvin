...
class MY_WP_Translate {
	...
	private function define_admin_hooks() {
        ...
        $this->loader->add_action( 'wp_ajax_mtswpt_translation_panel', $plugin_admin, 'ajax_mtswpt_translation_panel' );
        $this->loader->add_action( 'wp_ajax_mtswpt_save_translation', $plugin_admin, 'ajax_mtswpt_save_translation' );
        $this->loader->add_action( 'wp_ajax_mtswpt_add_plugin', $plugin_admin, 'ajax_mtswpt_add_plugin' );
        $this->loader->add_action( 'wp_ajax_mtswpt_remove_plugin', $plugin_admin, 'ajax_mtswpt_remove_plugin' );
        $this->loader->add_action( 'wp_ajax_mtswpt_save_state', $plugin_admin, 'ajax_mtswpt_save_state' );
        $this->loader->add_action( 'wp_ajax_mtswpt_import_strings', $plugin_admin, 'ajax_mtswpt_import_strings' );
        $this->loader->add_action( 'wp_ajax_mtswpt_update_export_code', $plugin_admin, 'ajax_mtswpt_update_export_code' );
