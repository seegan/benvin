			...
			<div class="x_panel">
				...
				<div class="x_content">
					<ul>
						...
						<li class="parallelogram"><a href="<?php echo admin_url('admin.php?page=deposit').$id_txt_new;  ?>">New Deposit ( SD )</a></li>
			...
			<div class="x_panel">
				...
				<div class="x_content">
					<ul>
						...
						<li class="parallelogram"><a href="<?php echo admin_url('admin.php?page=obc_report').$id_txt_list; ?>">Receipt List</a></li>
