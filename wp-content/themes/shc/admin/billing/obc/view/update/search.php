			...
			<div class="x_panel">
				...
				<div class="x_content">
					<div class="form-horizontal form-label-left" id="create_return">
						...
						<div class="col-lg-6">
							<div class="address-line">Date : <span class="deposit-date"><?php echo $obc_date; ?></span></div>
							<div class="address-line">Time : <span class="deposit-time"><?php echo $obc_time; ?></span></div>
