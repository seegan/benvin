        ...
        <div class="x_title">
            ...
            <div class="filter-section">
              <div class="row">
                ...
                <div class="col-md-2">
                  <input type="text" name="lot_no" class="lot_no" value="<?php echo $lots->lot_no; ?>" placeholder="Lot Number">
                </div>
                <div class="col-md-2">
                  <input type="text" name="product_name" class="product_name" value="<?php echo $lots->product_name; ?>" placeholder="Product Name">
                </div>
                <div class="col-md-2">
                  <input type="text" name="product_type" class="product_type" value="<?php echo $lots->product_type; ?>" placeholder="Product Name">
                </div>
              </div>
